...
5. `progress` nur Exceptions (`data.ok`).

Test-Fokus: docs/test-focus.md (ROI-Checkliste, kein Gate).
...
Nur Hubs (>10 Nachbarn): genau 1 Alignment-Zusatzverify (Dependent, sonst stärkster Overlap). Blätter (≤3): nichts, nie transitiv. Genug = eigenes Verify grün + 1 Alignment grün + Land-Gate grün.
